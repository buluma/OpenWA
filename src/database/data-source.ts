...
// mirroring the runtime data connection (app.module.ts). A broad '**' glob would also sweep in the
// main-owned auth/audit entities and pollute `migration:generate` against the data DB with their DDL.
const dataEntities = [
